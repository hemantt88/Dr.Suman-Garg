      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center text-center mb-16 max-w-2xl mx-auto">
          <motion.span
            ...
            viewport={{ once: true }}
            className="text-blue-600 font-display font-medium tracking-[0.2em] uppercase text-xs mb-4"
          >
            Premium Services
          </motion.span>
          <motion.h2
          ...
          >
            Multi-specialty healthcare for the <span className="text-blue-600">whole family</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="group p-6 rounded-2xl glass-card transition-all duration-300 hover:shadow-lg hover:border-blue-100 flex flex-col items-center text-center relative"
            >
              ...
              <button 
                ...
                className="text-[10px] font-bold uppercase tracking-wider text-blue-600 hover:text-blue-700 transition-colors cursor-pointer"
              >
                Book Now →
              </button>
            </motion.div>
